...
def obtener_menu_privado():
    return [
        {
            "nombre": "Inicio",
            "ruta": "inicio",  # Se usará en JavaScript
                        "seccion": "presentation",
            "submenus": []
        },
      
        {
            ...
            "ruta": "servicios",
            "submenus": [
                {"nombre": "Mostrar como Texto", "formato": "text"},
                {"nombre": "Mostrar como JSON", "formato": "json"},
            ]
        },
        {
        ...
        {
            "nombre": "Iniciar Sesión",
            "ruta": "login",  # Ruta simple para iniciar sesión
            "submenus": []
        },
         {
            "nombre": "Cerrar Sesión",
...
def esta_autenticado():
    # Usando Flask-Login para verificar la autenticación
    return current_user.is_authenticated
